<?php
    ...
    $sqlCommand = '';
    if ($level != '0') {
        $sqlCommand .= 'c_id = '.$level.' and ';
    }

    if ($input == '1') {
        $sqlCommand .= 'p_input <= 6.0 and ';
    }
    if ($input == '2') {
        $sqlCommand .= 'p_input >= 6.0 and ';
    }
    ...
    if ($row && $page == 0) {
        echo "<tr><td colspan = '6'><div id = 'PageDiv' class = 'pgDown'></div></td></tr>";
    } elseif ($row && $page != 0) {
        echo "<tr><td colspan = '6'><div id = 'PageDiv' class = 'pgUp pgDown'></div></td></tr>";
    } elseif ($page != 0) {
        echo "<tr><td colspan = '6'><div id = 'PageDiv' class = 'pgUp'></div></td></tr>";
    } else {
        echo "<tr><td colspan = '6'><div id = 'PageDiv'></div></td></tr>";
    }
